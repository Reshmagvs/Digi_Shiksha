...
It provides **personalized, multilingual tutoring** in foundational literacy and numeracy using:
...
| Agent Name            | Purpose |
|----------------------|---------|
| Literacy Agent       | Reading help, word building, comprehension |
| Numeracy Agent       | Arithmetic, step-by-step problem solving |
| Translator Agent     | Provides multilingual explanations |
